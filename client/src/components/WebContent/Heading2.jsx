        ...
        return (
            <>
                <div className="flex justify-end">
                      <TooltipComponent msg="Currently, the website does not contain any H2 headings or associated data." />
                </div>
            ...
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 shadow-lg">
                <thead className="text-xs uppercase text-white bg-gray-900 tracking-wide">
                    <tr>
                        ...
                        <th scope="col" className="px-6 py-3" style={{ width: '200px' }}>Recommended Heading (H2) <TooltipComponent msg={recommendedSubheadingsMsg}/></th>
                ...
                <tbody>
                    {currentItems.map((item, index) => (
                        <tr key={index} className="bg-white border-b hover:bg-gray-50 text-neutralDGrey">
                            <td className="px-6 py-4 align-top text-justify leading-6 tracking-wide font-medium">{item.h2}</td>
                            <td 
